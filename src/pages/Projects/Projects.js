  ...
  return (
    <div className="flex flex-col items-center justify-center" id="projects">
      <div className="mb-6">
        ...
        <hr className="mt-2 mb-6 border-1 w-32 mx-auto border-blue-gray-300" />
      </div>
      <div className="grid items-center grid-cols-1 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-6">
